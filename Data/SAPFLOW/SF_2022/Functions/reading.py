...
def sf_env(path_input,ini_date,SF,k):
    ...
    ENV=ENV.drop(columns=['RH','NetRad(MJ/m2h)']).loc['2022-04-20 00:30:00':]  
    env=ENV.copy()
    ...
    return new_df #returns cropped SF+Weather & SF+WEATHER+SM